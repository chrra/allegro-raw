...
struct ALLEGRO_BITMAP_INTERFACE
{
    ...
    */
   int (*upload_bitmap)(ALLEGRO_BITMAP *bitmap);
...
int _al_format_has_alpha(int format);
int _al_pixel_format_is_real(int format);
...
int _al_transform_is_translation(const ALLEGRO_TRANSFORM* trans,
   float *dx, float *dy);
