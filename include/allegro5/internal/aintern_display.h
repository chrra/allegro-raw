...
struct ALLEGRO_DISPLAY_INTERFACE
{
   ...
   int (*set_current_display)(ALLEGRO_DISPLAY *d);
   ...
   int (*acknowledge_resize)(ALLEGRO_DISPLAY *d);
   int (*resize_display)(ALLEGRO_DISPLAY *d, int width, int height);
   ...
   int (*is_compatible_bitmap)(ALLEGRO_DISPLAY *display, ALLEGRO_BITMAP *bitmap);
   ...
   int (*wait_for_vsync)(ALLEGRO_DISPLAY *display);

   int (*set_mouse_cursor)(ALLEGRO_DISPLAY *display,
      ALLEGRO_MOUSE_CURSOR *cursor);
   int (*set_system_mouse_cursor)(ALLEGRO_DISPLAY *display,
      ALLEGRO_SYSTEM_MOUSE_CURSOR cursor_id);
   int (*show_mouse_cursor)(ALLEGRO_DISPLAY *display);
   int (*hide_mouse_cursor)(ALLEGRO_DISPLAY *display);
   ...
   int (*toggle_display_flag)(ALLEGRO_DISPLAY *display, int flag, int onoff);
...
/* Defined in tls.c */
int _al_set_current_display_only(ALLEGRO_DISPLAY *display);
