...
AL_FUNC(int, al_toggle_display_flag, (ALLEGRO_DISPLAY *display, int flag, int onoff));
...
AL_FUNC(int, al_acknowledge_resize, (ALLEGRO_DISPLAY *display));
AL_FUNC(int, al_resize_display,     (ALLEGRO_DISPLAY *display, int width, int height));
AL_FUNC(void, al_flip_display,       (void));
AL_FUNC(void, al_update_display_region, (int x, int y, int width, int height));
AL_FUNC(int, al_is_compatible_bitmap, (ALLEGRO_BITMAP *bitmap));

AL_FUNC(int, al_get_num_display_modes, (void));
AL_FUNC(ALLEGRO_DISPLAY_MODE*, al_get_display_mode, (int index,
        ALLEGRO_DISPLAY_MODE *mode));

AL_FUNC(int, al_wait_for_vsync, (void));
...
AL_FUNC(int, al_get_monitor_info, (int adapter, ALLEGRO_MONITOR_INFO *info));
...
/*Deferred drawing*/
AL_FUNC(void, al_hold_bitmap_drawing, (int hold));
AL_FUNC(int, al_is_bitmap_drawing_held, (void));
