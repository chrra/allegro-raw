...
AL_FUNC(int, al_ustr_next, (const ALLEGRO_USTR *us, int *pos));
AL_FUNC(int, al_ustr_prev, (const ALLEGRO_USTR *us, int *pos));
...
/* Insert */
AL_FUNC(int, al_ustr_insert, (ALLEGRO_USTR *us1, int pos,
      const ALLEGRO_USTR *us2));
AL_FUNC(int, al_ustr_insert_cstr, (ALLEGRO_USTR *us, int pos,
      const char *us2));
AL_FUNC(size_t, al_ustr_insert_chr, (ALLEGRO_USTR *us, int pos, int32_t c));

/* Append */
AL_FUNC(int, al_ustr_append, (ALLEGRO_USTR *us1, const ALLEGRO_USTR *us2));
AL_FUNC(int, al_ustr_append_cstr, (ALLEGRO_USTR *us, const char *s));
AL_FUNC(size_t, al_ustr_append_chr, (ALLEGRO_USTR *us, int32_t c));
AL_PRINTFUNC(int, al_ustr_appendf, (ALLEGRO_USTR *us, const char *fmt, ...),
      2, 3);
AL_FUNC(int, al_ustr_vappendf, (ALLEGRO_USTR *us, const char *fmt,
      va_list ap));

/* Remove */
AL_FUNC(int, al_ustr_remove_chr, (ALLEGRO_USTR *us, int pos));
AL_FUNC(int, al_ustr_remove_range, (ALLEGRO_USTR *us, int start_pos,
      int end_pos));
AL_FUNC(int, al_ustr_truncate, (ALLEGRO_USTR *us, int start_pos));
AL_FUNC(int, al_ustr_ltrim_ws, (ALLEGRO_USTR *us));
AL_FUNC(int, al_ustr_rtrim_ws, (ALLEGRO_USTR *us));
AL_FUNC(int, al_ustr_trim_ws, (ALLEGRO_USTR *us));

/* Assign */
AL_FUNC(int, al_ustr_assign, (ALLEGRO_USTR *us1, const ALLEGRO_USTR *us2));
AL_FUNC(int, al_ustr_assign_substr, (ALLEGRO_USTR *us1, const ALLEGRO_USTR *us2,
      int start_pos, int end_pos));
AL_FUNC(int, al_ustr_assign_cstr, (ALLEGRO_USTR *us1, const char *s));

/* Replace */
AL_FUNC(size_t, al_ustr_set_chr, (ALLEGRO_USTR *us, int pos, int32_t c));
AL_FUNC(int, al_ustr_replace_range, (ALLEGRO_USTR *us1, int start_pos1,
...
AL_FUNC(int, al_ustr_rfind_cstr, (const ALLEGRO_USTR *haystack, int start_pos,
      const char *needle));
AL_FUNC(int, al_ustr_find_replace, (ALLEGRO_USTR *us, int start_pos,
      const ALLEGRO_USTR *find, const ALLEGRO_USTR *replace));
AL_FUNC(int, al_ustr_find_replace_cstr, (ALLEGRO_USTR *us, int start_pos,
      const char *find, const char *replace));

/* Compare */
AL_FUNC(int, al_ustr_equal, (const ALLEGRO_USTR *us1, const ALLEGRO_USTR *us2));
...
AL_FUNC(int, al_ustr_ncompare, (const ALLEGRO_USTR *us1, const ALLEGRO_USTR *us2,
      int n));
AL_FUNC(int, al_ustr_has_prefix,(const ALLEGRO_USTR *u, const ALLEGRO_USTR *v));
AL_FUNC(int, al_ustr_has_prefix_cstr, (const ALLEGRO_USTR *u, const char *s));
AL_FUNC(int, al_ustr_has_suffix,(const ALLEGRO_USTR *u, const ALLEGRO_USTR *v));
AL_FUNC(int, al_ustr_has_suffix_cstr,(const ALLEGRO_USTR *us1, const char *s));
