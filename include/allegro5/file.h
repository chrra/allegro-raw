...
typedef struct ALLEGRO_FILE_INTERFACE
{
   ...
   AL_METHOD(int,    fi_fflush, (ALLEGRO_FILE *f));
   AL_METHOD(int64_t, fi_ftell, (ALLEGRO_FILE *f));
   AL_METHOD(int,    fi_fseek, (ALLEGRO_FILE *f, int64_t offset, int whence));
   AL_METHOD(int,    fi_feof, (ALLEGRO_FILE *f));
...
AL_FUNC(int, al_fflush, (ALLEGRO_FILE *f));
AL_FUNC(int64_t, al_ftell, (ALLEGRO_FILE *f));
AL_FUNC(int, al_fseek, (ALLEGRO_FILE *f, int64_t offset, int whence));
AL_FUNC(int, al_feof, (ALLEGRO_FILE *f));
