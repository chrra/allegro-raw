...
AL_FUNC(int, al_install_system, (int version, int (*atexit_ptr)(void (*)(void))));
AL_FUNC(void, al_uninstall_system, (void));
AL_FUNC(int, al_is_system_installed, (void));
...
AL_FUNC(int, al_inhibit_screensaver, (int inhibit));
