...
typedef struct ALLEGRO_KEYBOARD_EVENT
{
   ...
   int repeat;                 /* auto-repeated or not */
 ...
 */
AL_FUNC(int, al_emit_user_event, (ALLEGRO_EVENT_SOURCE *, ALLEGRO_EVENT *,
                                   void (*dtor)(ALLEGRO_USER_EVENT *)));
AL_FUNC(void, al_unref_user_event, (ALLEGRO_USER_EVENT *));
AL_FUNC(void, al_set_event_source_data, (ALLEGRO_EVENT_SOURCE*, void * data));
AL_FUNC(void *, al_get_event_source_data, (const ALLEGRO_EVENT_SOURCE*));
...
AL_FUNC(int, al_is_event_queue_empty, (ALLEGRO_EVENT_QUEUE*));
AL_FUNC(int, al_get_next_event, (ALLEGRO_EVENT_QUEUE*, ALLEGRO_EVENT *ret_event));
AL_FUNC(int, al_peek_next_event, (ALLEGRO_EVENT_QUEUE*, ALLEGRO_EVENT *ret_event));
AL_FUNC(int, al_drop_next_event, (ALLEGRO_EVENT_QUEUE*));
...
AL_FUNC(int, al_wait_for_event_timed, (ALLEGRO_EVENT_QUEUE*,
                                        ALLEGRO_EVENT *ret_event,
                                        float secs));
AL_FUNC(int, al_wait_for_event_until, (ALLEGRO_EVENT_QUEUE *queue,
                                        ALLEGRO_EVENT *ret_event,
