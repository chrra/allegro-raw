...
AL_FUNC(int,           al_is_mouse_installed,  (void));
AL_FUNC(int,           al_install_mouse,       (void));
...
AL_FUNC(int,           al_set_mouse_xy,        (struct ALLEGRO_DISPLAY *display, int x, int y));
AL_FUNC(int,           al_set_mouse_z,         (int z));
AL_FUNC(int,           al_set_mouse_w,         (int w));
AL_FUNC(int,           al_set_mouse_axis,      (int axis, int value));
AL_FUNC(void,           al_get_mouse_state,     (ALLEGRO_MOUSE_STATE *ret_state));
AL_FUNC(int,           al_mouse_button_down,   (const ALLEGRO_MOUSE_STATE *state, int button));
...
AL_FUNC(int, al_set_mouse_cursor, (struct ALLEGRO_DISPLAY *display,
                                    ALLEGRO_MOUSE_CURSOR *cursor));
AL_FUNC(int, al_set_system_mouse_cursor, (struct ALLEGRO_DISPLAY *display,
                                           ALLEGRO_SYSTEM_MOUSE_CURSOR cursor_id));
AL_FUNC(int, al_show_mouse_cursor, (struct ALLEGRO_DISPLAY *display));
AL_FUNC(int, al_hide_mouse_cursor, (struct ALLEGRO_DISPLAY *display));
AL_FUNC(int, al_get_mouse_cursor_position, (int *ret_x, int *ret_y));
AL_FUNC(int, al_grab_mouse, (struct ALLEGRO_DISPLAY *display));
AL_FUNC(int, al_ungrab_mouse, (void));
