...
AL_FUNC(int, al_save_config_file, (const char *filename, const ALLEGRO_CONFIG *config));
AL_FUNC(int, al_save_config_file_f, (ALLEGRO_FILE *file, const ALLEGRO_CONFIG *config));
