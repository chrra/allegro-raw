...
struct ALLEGRO_DISPLAY_WIN
{
    ...
    */
   volatile int end_thread;    /* The display thread should end */
   volatile int thread_ended;  /* The display thread has ended */
...
/* keyboard routines */
void _al_win_kbd_handle_key_press(int scode, int vcode, int extended,
                           int repeated, ALLEGRO_DISPLAY_WIN *win_disp);
void _al_win_kbd_handle_key_release(int scode, int vcode, int extended,
                           ALLEGRO_DISPLAY_WIN *win_disp);

/* mouse routines */
void _al_win_mouse_handle_move(int x, int y, int abs, ALLEGRO_DISPLAY_WIN *win_disp);
void _al_win_mouse_handle_wheel(int d, int abs, ALLEGRO_DISPLAY_WIN *win_disp);
void _al_win_mouse_handle_hwheel(int d, int abs, ALLEGRO_DISPLAY_WIN *win_disp);
void _al_win_mouse_handle_button(int button, int down, int x, int y, int abs, ALLEGRO_DISPLAY_WIN *win_disp);
...
extern int _al_win_disable_screensaver;
...
HICON _al_win_create_icon(HWND wnd, ALLEGRO_BITMAP *sprite, int xfocus, int yfocus, int is_cursor, int resize);

/* window decorations */
void _al_win_set_window_position(HWND window, int x, int y);
void _al_win_get_window_position(HWND window, int *x, int *y);
void _al_win_toggle_window_frame(ALLEGRO_DISPLAY *display, HWND window, int w, int h, int onoff);
int _al_win_toggle_display_flag(ALLEGRO_DISPLAY *display, int flag, int onoff);
...
int _al_win_set_mouse_cursor(ALLEGRO_DISPLAY *display, ALLEGRO_MOUSE_CURSOR *cursor);
int _al_win_set_system_mouse_cursor(ALLEGRO_DISPLAY *display, ALLEGRO_SYSTEM_MOUSE_CURSOR cursor_id);
int _al_win_show_mouse_cursor(ALLEGRO_DISPLAY *display);
int _al_win_hide_mouse_cursor(ALLEGRO_DISPLAY *display);
