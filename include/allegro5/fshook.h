...
struct ALLEGRO_FS_INTERFACE {
   ...
   AL_METHOD(int,            fs_update_entry,     (ALLEGRO_FS_ENTRY *e));
   ...
   AL_METHOD(int,            fs_entry_exists,     (ALLEGRO_FS_ENTRY *e));
   AL_METHOD(int,            fs_remove_entry,     (ALLEGRO_FS_ENTRY *e));

   AL_METHOD(int,            fs_open_directory,   (ALLEGRO_FS_ENTRY *e));
   AL_METHOD(ALLEGRO_FS_ENTRY *, fs_read_directory,(ALLEGRO_FS_ENTRY *e));
   AL_METHOD(int,            fs_close_directory,  (ALLEGRO_FS_ENTRY *e));

   AL_METHOD(int,            fs_filename_exists,  (const char *path));
   AL_METHOD(int,            fs_remove_filename,  (const char *path));
   AL_METHOD(char *,          fs_get_current_directory, (void));
   AL_METHOD(int,            fs_change_directory, (const char *path));
   AL_METHOD(int,            fs_make_directory,   (const char *path));
...
AL_FUNC(int,                 al_update_fs_entry,  (ALLEGRO_FS_ENTRY *e));
...
AL_FUNC(int,                 al_fs_entry_exists,  (ALLEGRO_FS_ENTRY *e));
AL_FUNC(int,                 al_remove_fs_entry,  (ALLEGRO_FS_ENTRY *e));

AL_FUNC(int,                 al_open_directory,   (ALLEGRO_FS_ENTRY *e));
AL_FUNC(ALLEGRO_FS_ENTRY *,   al_read_directory,   (ALLEGRO_FS_ENTRY *e));
AL_FUNC(int,                 al_close_directory,  (ALLEGRO_FS_ENTRY *e));

AL_FUNC(int,                 al_filename_exists,  (const char *path));
AL_FUNC(int,                 al_remove_filename,  (const char *path));
AL_FUNC(char *,               al_get_current_directory, (void));
AL_FUNC(int,                 al_change_directory, (const char *path));
AL_FUNC(int,                 al_make_directory,   (const char *path));
