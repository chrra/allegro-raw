...
AL_FUNC(int,           al_install_joystick,    (void));
AL_FUNC(void,           al_uninstall_joystick,  (void));
AL_FUNC(int,           al_is_joystick_installed, (void));
AL_FUNC(int,           al_reconfigure_joysticks, (void));
...
AL_FUNC(int,           al_get_joystick_active, (ALLEGRO_JOYSTICK *));
