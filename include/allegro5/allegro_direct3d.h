...
AL_FUNC(int,               al_have_d3d_non_pow2_texture_support,   (void));
AL_FUNC(int,               al_have_d3d_non_square_texture_support, (void));
AL_FUNC(void,               al_get_d3d_texture_position, (ALLEGRO_BITMAP *bitmap, int *u, int *v));
AL_FUNC(int,               al_is_d3d_device_lost, (ALLEGRO_DISPLAY *display));
